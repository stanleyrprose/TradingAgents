    ...
    def market_analyst_node(state):
        ...
        if is_equity_occ_option:
            option_instruction = (
                ...
                "implied volatility, Greeks, liquidity, and deterministic scenario "
                "estimates. Use the expiry breakeven, theta burn, "
                "required-underlying-to-preserve-premium estimates, and spot×IV "
                "matrix when relevant. Call them scenario/model estimates, never an "
                "executable quote, market fair value, or guaranteed P/L. Clearly "
                "identify the "
